...
async def main():
    ...
    TF = first_day_prev_month.strftime("%Y-%m-%d")
    TT = last_day_prev_month.strftime("%Y-%m-%d")

    HF = (first_day_prev_month - timedelta(days=120)).strftime("%Y-%m-%d")
    HT = TT

    display_month = first_day_prev_month.strftime("%B %Y")
